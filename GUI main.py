...
replace_button = ui.Button("Replace", button_color=("light blue",""))
add_button = ui.Button("Add", button_color=("light blue",""))
insert_button = ui.Button("Insert after")
complete_button = ui.Button("Complete", button_color=("green",""))
...
window_layout = [
                [clock],
                [input_box],
                [replace_button, add_button, insert_button, complete_button],
                [task_list],
...
while True:
    ...
    # Loop pauses at the read() line until an event is received. Timeout allows the loop to proceed (10ms?)
